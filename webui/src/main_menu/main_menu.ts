  ...
  #getElement(el: HTMLElement): DocumentFragment {
    ...
    template.innerHTML = /* html */ `
      <md-menu id="menu-options" anchor="menu-button">
        ...
        <md-sub-menu hover-close-delay="0" id="omk-menu">
          <md-menu-item slot="item" class="sub-menu-entry">
            <div slot="headline">${i18n.t('omk_menu')}</div>
            <md-icon slot="end">tune</md-icon>
          </md-menu-item>
          <md-menu positioning="popover" slot="menu" x-offset="2">
            <md-menu-item id="omk-device">
              <div slot="headline">${i18n.t('omk_menu_device')}</div>
            </md-menu-item>
            <md-menu-item id="omk-raw-config">
              <div slot="headline">${i18n.t('omk_menu_raw_config')}</div>
            </md-menu-item>
            <md-menu-item id="omk-logs">
              <div slot="headline">${i18n.t('omk_menu_logs')}</div>
            </md-menu-item>
            <md-divider role="separator" tabindex="-1"></md-divider>
            <md-menu-item id="omk-restart-keymint">
              <div slot="headline">${i18n.t('omk_menu_restart_keymint')}</div>
            </md-menu-item>
            <md-menu-item id="omk-restart-injector">
              <div slot="headline">${i18n.t('omk_menu_restart_injector')}</div>
            </md-menu-item>
            <md-menu-item id="omk-restart-all">
              <div slot="headline">${i18n.t('omk_menu_restart_all')}</div>
            </md-menu-item>
          </md-menu>
        </md-sub-menu>
        <md-divider role="separator" tabindex="-1"></md-divider>
    ...
    const items: Array<[string, string]> = [
      ...
      ['omk-device', 'menu-omk-device'],
      ['omk-raw-config', 'menu-omk-raw-config'],
      ['omk-logs', 'menu-omk-logs'],
      ['omk-restart-keymint', 'menu-omk-restart-keymint'],
      ['omk-restart-injector', 'menu-omk-restart-injector'],
      ['omk-restart-all', 'menu-omk-restart-all'],
      ['help', 'menu-help'],
      ['about', 'menu-about'],
    ]
